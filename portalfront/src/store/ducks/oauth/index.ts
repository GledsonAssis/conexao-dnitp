...
const reducer: Reducer<OAuthState> = (state = INITAL_STATE, action: any) => {
  switch (action.type) {
    ...
    case OAuthTypes.LOAD_REQUEST_GET_PROFILE:
      return {
        ...state,
        loading: true,
        error: false,
    ...
    case OAuthTypes.LOAD_SUCCESS_GET_PROFILE:
      return {
        ...state,
        loading: false,
        error: false,
    ...
    case OAuthTypes.LOAD_FAILURE_GET_PROFILE:
      return {
        ...state,
        loading: false,
        errors: action.payload,
    ...
    case OAuthTypes.LOAD_REQUEST_SUBMIT:
      return {
        ...state,
        loading: true,
        error: false,
    ...
    case OAuthTypes.LOAD_SUCCESS_SUBMIT:
      return {
        ...state,
        loading: false,
        error: false,
    ...
    case OAuthTypes.LOAD_FAILURE_SUBMIT:
      return {
        ...state,
        loading: false,
        errors: action.payload,
