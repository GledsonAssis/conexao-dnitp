...
import logoConexao from '@/assets/images/logo-conexao-no-text.svg';
...
export const Breadcrumbs: React.FC<Props> = ({ translation }) => {
  ...
  return (
    <div className="container-lg" style={{ position: 'relative' }}>
      ...
      <div className="contrast-ignore-bg container-lg cnx-logo">
        <img src={logoConexao} alt="logo-CNX" className={'contrast-ignore-bg'} />
      </div>
    </div>
  );
};
