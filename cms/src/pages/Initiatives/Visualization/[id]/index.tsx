...
export const EditInitiativePage: React.FC<Props> = ({ propsModel, t }) => {
  ...
  function onSubmit(data: any) {
    dispatch(actionsInitiatives.loadSubmitRequest({ ...data, idInitiative: +id, typeList: 'visualization' }));
  }
  ...
  return (
    <>
      {`${data?.id}` === id ?
        <Form
          type={'visualization'}
          titlePage={t('pages:initiatives.details.pageTitle.visualization')}
