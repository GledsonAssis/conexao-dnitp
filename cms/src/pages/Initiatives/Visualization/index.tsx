    ...
    <div className="main-content mt-3 px-md-3" id="main-content">
      <div className="row">
        <div className='col-12 d-flex justify-content-between align-items-center'>
          <p className="h1">{t('pages:initiatives.labels.pageTitle.visualization')}</p>
        </div>
        <div className='col-12'>
          <div className="header-search w-100 my-4"></div>
          <Table
            Title={t('pages:initiatives.labels.listTitleView')}
            Options={{
              id: 'initiatives',
              paginate: true,
          ...
          >
            <ActionTrigger nameKey='top-bar' className={'mr-1'}>
              <button
                ...
                type="button"
                onClick={() => dispatch(actionsInitiatives.loadGetListCSVsRequest({ typeList: 'visualization', keyword: keywordSearch }))}
              >
