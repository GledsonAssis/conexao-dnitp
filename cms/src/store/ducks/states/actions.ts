...
export const loadFieldKnowledgesRequest = (data?: any) => ({
  type: StatesTypes.LOAD_REQUEST_FIELDKNOWLEDGES,
  payload: data,
});
export const loadFieldKnowledgesSuccess = (data: any[]) => ({
  type: StatesTypes.LOAD_SUCCESS_FIELDKNOWLEDGES,
  payload: data,
});
export const loadFieldKnowledgesFailure = (err: any) => ({
  type: StatesTypes.LOAD_FAILURE_FIELDKNOWLEDGES,
  payload: err,
});
