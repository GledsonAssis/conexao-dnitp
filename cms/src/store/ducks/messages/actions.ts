...
export const loadMessagesStatusRequest = (data?: any) => ({
  type: MessagesTypes.LOAD_REQUEST_MESSAGES_STATUS,
  payload: data,
});
export const loadMessagesStatusSuccess = (data: any) => ({
  type: MessagesTypes.LOAD_SUCCESS_MESSAGES_STATUS,
  payload: data,
});
export const loadMessagesStatusFailure = (err: any) => ({
  type: MessagesTypes.LOAD_FAILURE_MESSAGES_STATUS,
  payload: err,
});
