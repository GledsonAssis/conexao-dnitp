export enum MessagesTypes {
  ...
  LOAD_REQUEST_MESSAGES_STATUS = '@messages/MESSAGES_STATUS/LOAD_REQUEST',
  LOAD_SUCCESS_MESSAGES_STATUS = '@messages/MESSAGES_STATUS/LOAD_SUCCESS',
  LOAD_FAILURE_MESSAGES_STATUS = '@messages/MESSAGES_STATUS/LOAD_FAILURE',
...
export interface MessagesState {
  ...
  readonly messagesStatus: IdName[];
