...
class BRWizard {
  ...
  component: any
  DOMstrings: {
    stepFormPanelClass: string
    // stepFormPanels: document.querySelectorAll('.wizard-panel'),
    stepFormPanels: any; stepNextBtnClass: string; stepPrevBtnClass: string
    // stepsBar: document.querySelector('.wizard-progress'),
    stepsBar: any; stepsBarClass: string; stepsBtnClass: string
    // stepsBtns: document.querySelectorAll(`.wizard-progress-btn`),
    stepsBtns: any
    // stepsForm: document.querySelector('.wizard-form'),
    stepsForm: any
  }
  removeAttributes: (elemSet: any, attrName: any) => void
  findParent: (elem: any, parentClass: any) => any
  getActiveStep: (elem: any) => number
  setActiveStep: (activeStepNum: any) => void
  getActivePanel: () => any
  setActivePanel: (activePanelNum: any) => void
  setStepsNum: () => void
  ...
  _setAttWizard() {
    this.component.setAttribute('br-wizard-att', '');
  }
