...
class BRUpload {
  ...
  constructor(name, component, uploadFiles, listFilesUpdated?) {
    ...
    this._infoRow = this.component.querySelector('.info-row');
    this._defaultList = this.component.querySelector('.default-list');
  ...
  _setBehavior() {
    ...
    if (this._inputElement) {
      ...
      this.component.append(this._infoRow);
      this.component.append(this._defaultList);
      this.component.append(this._fileList);


      this._fileArray = Array.from(this._inputElement.files);
      // this._renderDefaultItens()
